...
class SellCoinServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->sellCoinService = new SellCoinService($this->coinDataSource, $this->walletDataSource);
    }
     ...
     * @test
     */
    public function sellsCoinFromWallet()
    {
        $coinId = '90';
        $amountUsd = 4;
        $walletId = '0';
        ...
        $this->walletDataSource
            ->shouldReceive('sellCoinFromWallet')
            ->with('0', Mockery::type(Coin::class), $amountUsd)
            ->once();

        $this->sellCoinService->execute($coinId, '0', $amountUsd);
    }
}
